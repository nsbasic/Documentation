...
const cacheName = 'PhoneGapSMS-2020-09-07 11:37:29.539735'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'PhoneGapSMS'.length) === 'PhoneGapSMS') {
