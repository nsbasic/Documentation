...
const cacheName = 'PhoneGapBarcode-2020-09-07 11:26:52.859080'; // unique value, generated each deploy
const contentToCache = [
  'index.html',
  'scanner.mp3.js',
  'code.js',
  'includes/scanner.mp3',
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'PhoneGapBarcode'.length) === 'PhoneGapBarcode') {
