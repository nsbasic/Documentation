...
const cacheName = 'Carousel-2024-04-12 08:44:38.451273'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Carousel'.length) === 'Carousel') {
