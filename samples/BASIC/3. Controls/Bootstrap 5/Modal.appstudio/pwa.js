...
const cacheName = 'Modal-2020-04-05 10:30:14.382639'; // unique value, generated each deploy
const contentToCache = [
  ...
  'toolbox/bs5/dist/open-iconic/css/open-iconic-bootstrap.min.css',
  'toolbox/bs5/dist/open-iconic/fonts/open-iconic.woff',
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Modal'.length) === 'Modal') {
