...
const cacheName = 'app-2019-06-03 17:21:40.886195'; // unique value, generated each deploy
const contentToCache = [
  ...
  'nsb/library/navigo.min.js',
  'nsb/library/jquery.modal.min.js',
];

; // list of files to cache
console.log('[pwa.js] Startup', cacheName);

self.addEventListener('activate', ((e) => {
  'use strict';

  console.log('[pwa.js] Clear old caches');
  e.waitUntil(
...
self.addEventListener('install', (e) => {
  ...
  console.log('[pwa.js] Install');
  e.waitUntil(
    caches.open(cacheName).then((cache) => {
      console.log('[pwa.js] Caching all: app shell and content');
...
self.addEventListener('fetch', (e) => {
  ...
  console.log('[pwa.js] fetch', e.request.url)
...
if (typeof self.skipWaiting === 'function') {
  console.log('[pwa.js] self.skipWaiting() is supported.');
  ...
  console.log('[pwa.js] self.skipWaiting() is not supported.');
}

if (self.clients && (typeof self.clients.claim === 'function')) {
  console.log('[pwa.js] self.clients.claim() is supported.');
  self.addEventListener('activate', function(e) {
    // See https://slightlyoff.github.io/ServiceWorker/spec/service_worker/index.html#clients-claim-method
    e.waitUntil(self.clients.claim());
  });
} else {
  console.log('[pwa.js] self.clients.claim() is not supported.');
}
