...
const cacheName = 'GetUserMediaCamera-2022-06-26 15:55:39.661942'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'GetUserMediaCamera'.length) === 'GetUserMediaCamera') {
