...
const cacheName = 'HeaderBodyFooter-2023-06-05 11:24:24.488136'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'HeaderBodyFooter'.length) === 'HeaderBodyFooter') {
