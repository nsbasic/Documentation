/* Graph API endpoint to show user profile and calendar for Office 365 users.
 
If you're having trouble signing on, clear your browser cache!

This should be run from a server.

Register the app and get the clientID here:
https://apps.dev.microsoft.com/#/appList
- Check Allow Implicit Flow
- Add Redirect URL: https://www.appstudio.dev/i/Office365/
- Add permission for Calendars.Read
- Add Home Page URL: https://www.appstudio.dev/i/Office365/

Additional documentation here:
https://docs.microsoft.com/en-us/azure/active-directory/develop/tutorial-v2-javascript-spa

For testing, use the Microsoft Graph Explorer:
...
// The endpoint address is hardcoded since the API calls back and restarts the app
// after it completes. 
var graphApiEndpoint = "https://graph.microsoft.com/v1.0/me";
// var graphApiEndpoint = "https://graph.microsoft.com/v1.0/me/events?$select=subject,body,bodyPreview,start,end";

var msalconfig = {
  clientID: "0542d099-2b2c-4486-9c9d-2dbf533850eb",
...
function callGraphApi() {
  ...
  if (!user) {
    ...
    userInfo.innerHTML = JSON.stringify(user, null, 4);

    // Now Call Graph API to show the user profile information:
    graphResponse.innerText = "Calling Graph ...";
    ...
    userAgentApplication.acquireTokenSilent(graphAPIScopes)
      .then(function(token) {
        ...
        callWebApiWithToken(graphApiEndpoint, token, graphResponse, accessToken);
      ...
      if (response.status === 200 && contentType && contentType.indexOf("application/json") !== -1) {
        response.json()
          .then(function(data) {
            ...
            if (showTokenElement) {
              showTokenElement.innerHTML = "<pre>" + token + "</pre>";
            }
          })
