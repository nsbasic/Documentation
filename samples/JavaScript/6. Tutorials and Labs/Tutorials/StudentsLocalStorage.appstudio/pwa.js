...
const cacheName = 'StudentsLocalStorage-2023-06-12 09:59:01.375881'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'StudentsLocalStorage'.length) === 'StudentsLocalStorage') {
