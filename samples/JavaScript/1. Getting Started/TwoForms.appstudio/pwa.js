...
const cacheName = 'TwoForms-2021-04-06 16:55:44.069767'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'TwoForms'.length) === 'TwoForms') {
