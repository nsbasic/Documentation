...
const cacheName = 'CordovaReceiveSMS-2020-09-07 11:36:24.971079'; // unique value, generated each deploy
const contentToCache = [
  'index.html',
  'code.js',
  'toolbox/bs3/dist/bsFunctions.js',
  'toolbox/bs3/dist/css/bootstrap.min.css',
  'toolbox/bs3/dist/js/bootstrap.min.js',
  'toolbox/bs3/dist/fa/css/font-awesome.min.css',
  'toolbox/bs3/dist/fa/fonts/fontawesome-webfont.woff2',
  'toolbox/bs3/dist/fa/fonts/fontawesome-webfont.ttf',
  'toolbox/bs3/dist/fa/fonts/fontawesome-webfont.woff',
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'CordovaReceiveSMS'.length) === 'CordovaReceiveSMS') {
