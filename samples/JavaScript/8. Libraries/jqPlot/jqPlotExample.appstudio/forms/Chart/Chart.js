var ChartBobsStuff=createMultiDimArray('10');
var ChartGracesStuff=createMultiDimArray('10');
var ChartPercentage=createMultiDimArray('10');
var ChartXaxis=createMultiDimArray('10');

var Line1,Line2,Line3,plot1,options;
...
HeaderBar2.onclick = function(choice) {
...
if(choice=="home") {
   ...
   plot1.destroy();
   nsbDOMAttr(Chart,'style.display',"none");
   ChangeForm(Form1);
