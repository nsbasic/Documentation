...
const cacheName = 'SQLSample2-2023-12-06 11:52:29.060195'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'SQLSample2'.length) === 'SQLSample2') {
