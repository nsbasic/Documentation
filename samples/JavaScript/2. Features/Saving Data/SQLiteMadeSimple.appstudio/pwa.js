...
const cacheName = 'SQLiteMadeSimple-2025-11-28 11:07:13.744137'; // unique value, generated each deploy
const contentToCache = [
  'index.html',
  'code.js',
  'toolbox/bs5/dist/bsFunctions.min.js',
  'toolbox/bs5/dist/css/bootstrap.min.css',
  'toolbox/bs5/dist/js/bootstrap.bundle.min.js',
  'toolbox/bs5/dist/icons/bootstrap-icons.css',
  'toolbox/bs5/dist/icons/fonts/bootstrap-icons.woff2',
  ...
  'nsb/library/jswasm/sqlite3.wasm',
  'nsb/library/jswasm/sqlite3-worker1-promiser.js',
  'nsb/library/jswasm/sqlite3-opfs-async-proxy.js',
  'nsb/library/jswasm/sqlite3.js',
  'nsb/library/jswasm/sqlite3-worker1.js',
];
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'SQLiteMadeSimple'.length) === 'SQLiteMadeSimple') {
