...
NSB.bs={};NSB.overlayShowing=[];NSB.bs.addProperties=function(ctrl,type){if(type!="DataTable_bs5"&&type!="Breadcrumbs_bs5"&&type!="Progressbar_bs5"&&type!="Dropdown_bs5"){$("#"+ctrl.id).addClass("collapse show");ctrl.collapse=function(arg){if(!arg)arg=$("#"+ctrl.id).hasClass("in")?"hide":"show";$("#"+ctrl.id).collapse(arg)}};ctrl.hide=function(options){// if the BS control has an overlay (popover, dropdown, etc.), BS calls
