...
const cacheName = 'SQLSample1-2024-05-16 16:59:37.527376'; // unique value, generated each deploy
const contentToCache = [
  ...
  'nsb/library/sqliteFunctions.js',
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'SQLSample1'.length) === 'SQLSample1') {
